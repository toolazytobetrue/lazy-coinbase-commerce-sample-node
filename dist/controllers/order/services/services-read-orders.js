...
exports.readServicesOrders = void 0;
const utils_1 = require("../../../util/utils");
const order_model_1 = require("../../../models/order/order.model");
const gold_mappings_1 = require("../../mappings/gold-mappings");
exports.readServicesOrders = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        filter = {
            $or: [
                {
                    powerleveling: { $ne: undefined }
                },
                {
                    services: { $ne: undefined }
                }
            ]
        };
...
//# sourceMappingURL=services-read-orders.js.map