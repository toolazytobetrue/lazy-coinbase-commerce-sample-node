...
const create_transaction_order_gold_1 = require("../../../api/order/create_transaction_order_gold");
const secrets_1 = require("../../../util/secrets");
const coupon_model_1 = require("../../../models/sales/coupon.model");
exports.createGoldOrder = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        const order = yield create_transaction_order_gold_1.transactionCreateGoldOrder(req.body.type, +mathjs_1.round(req.body.units, 2), latestStock, paymentGateway, userId, req.body.rsn, coupon, userIpAddress);
