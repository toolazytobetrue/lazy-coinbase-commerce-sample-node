...
exports.updateOrder = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        if (utils_1.isEmptyOrNull(req.body.status)) {
            return res.status(400).send("Order status is missing");
        }
        if (utils_1.isEmptyOrNull(req.body.delivered)) {
        ...
        if (!isNaN(req.body.payout) && +req.body.payout >= 0) {
            order.payout = +req.body.payout ? +mathjs_1.round(req.body.payout, 2) : 0;
        }
...
//# sourceMappingURL=order-update.js.map