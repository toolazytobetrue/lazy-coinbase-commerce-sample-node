...
exports.readOrdersByCalendar = exports.readOrders = void 0;
    ...
    try {
        ...
        switch (req.query.type) {
            case 'services':
                ...
                filter = Object.assign(Object.assign({}, filter), { account: undefined, gold: undefined });
...
exports.readOrdersByCalendar = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
