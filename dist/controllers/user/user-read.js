...
exports.readUsers = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        ...
        if (utils_1.isEmptyOrNull(req.query.groupId) || isNaN(+req.query.groupId) || !Number.isInteger(+req.query.groupId)) {
        ...
        if (!utils_1.isEmptyOrNull(req.query.filterBy) && !utils_1.isEmptyOrNull(req.query.filter)) {
            ...
            filter = Object.assign({}, filter, additionalFilter);
        }
        let users = [];
        if (pageNumber) {
