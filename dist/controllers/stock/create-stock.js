...
exports.createStock = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
        if (utils_1.isEmptyOrNull(req.body.osrs_units) || isNaN(+req.body.osrs_units)) {
            return res.status(400).send("OSRS units is missing");
        }
        if (utils_1.isEmptyOrNull(req.body.osrs_buying) || isNaN(+req.body.osrs_buying)) {
        ...
        if (utils_1.isEmptyOrNull(req.body.osrs_selling) || isNaN(+req.body.osrs_selling)) {
        ...
        if (utils_1.isEmptyOrNull(req.body.rs3_units) || isNaN(+req.body.rs3_units)) {
            return res.status(400).send("RS3 units is missing");
        }
        if (utils_1.isEmptyOrNull(req.body.rs3_buying) || isNaN(+req.body.rs3_buying)) {
        ...
        if (utils_1.isEmptyOrNull(req.body.rs3_selling) || isNaN(+req.body.rs3_selling)) {
        ...
        const stock = yield (new stock_model_1.Stock({
            ...
            rs3: {
                buying: +mathjs_1.round(req.body.rs3_buying, 2),
                selling: +mathjs_1.round(req.body.rs3_selling, 2),
                units: +mathjs_1.round(req.body.rs3_units, 2)
            },
            osrs: {
                buying: +mathjs_1.round(req.body.osrs_buying, 2),
                selling: +mathjs_1.round(req.body.osrs_selling, 2),
                units: +mathjs_1.round(req.body.osrs_units, 2)
            }
        })).save();
