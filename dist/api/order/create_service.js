...
exports.transactionCreateServicesOrder = void 0;
...
function transactionCreateServicesOrder(currency, paymentGateway, services = [], powerleveling = [], userId, coupon, ipAddress) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            let powerlevelingDocs = [];
            let serviceMinigamesDocs = [];
            if (powerleveling.length > 0) {
                powerlevelingDocs = yield powerleveling_model_1.Powerleveling.create(powerleveling);
            }
            if (services.length > 0) {
                ...
                serviceMinigamesDocs = yield serviceminigame_model_1.ServiceMinigame.create(serviceMinigames);
            }
            let sum = 0;
...
//# sourceMappingURL=create_service.js.map