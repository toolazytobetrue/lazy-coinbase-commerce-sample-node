    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            const order = yield order_model_1.Order.createCollection().
                ...
                then((obj) => {
                const total = +mathjs_1.round(account.price, 2);
                ...
                switch (order.paymentGateway.name) {
                    case 'Coinbase':
                        const coinbaseCharge = yield create_coinbase_invoice_1.createCoinbaseInvoice(order._id, order.amountWithDiscount, `${order._id}`, `Discount: ${coupon ? coupon.amount : 0}% - Account ID: ${account._id}`);
                        order.payment = {
                            coinbase: {
...
//# sourceMappingURL=create_transaction_order_account.js.map